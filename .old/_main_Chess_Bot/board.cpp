...
void Board::MakeMove(Move move) {
	...
	// Piece Has Moved
	this->boardPos[from.first][from.second].isMoved = true;
	...
	// Castle ~ ~
	else if (move.isCastle != 0) {

		if (move.isCastle == 1) {
			this->boardPos[6][0] = pieceFrom;
			this->boardPos[5][0] = this->boardPos[7][0];
			this->boardPos[4][0] = Piece(0, { 4, 0 }, 0);
			this->boardPos[7][0] = Piece(0, { 7, 0 }, 0);

			// King Protection
			this->eval += 0.5;
		}

		else if (move.isCastle == 2) {
			this->boardPos[2][0] = pieceFrom;
			this->boardPos[3][0] = this->boardPos[0][0];
			this->boardPos[4][0] = Piece(0, { 4, 0 }, 0);
			this->boardPos[0][0] = Piece(0, { 0, 0 }, 0);

			// King Protection
			this->eval += 0.5;
		}

		else if (move.isCastle == 3) {
			this->boardPos[6][7] = pieceFrom;
			this->boardPos[5][7] = this->boardPos[7][7];
			this->boardPos[4][7] = Piece(0, { 4, 7 }, 0);
			this->boardPos[7][7] = Piece(0, { 7, 7 }, 0);
			...
			this->boardPos[2][7] = pieceFrom;
			this->boardPos[3][7] = this->boardPos[0][7];
			this->boardPos[4][7] = Piece(0, { 4, 7 }, 0);
			this->boardPos[0][7] = Piece(0, { 0, 7 }, 0);
...
void Board::UndoMove(Move move) {
	...
	// Has Not Moved
	this->boardPos[to.first][to.second].isMoved = false;
	...
	// Castle ~ ~
		...
		if (move.isCastle == 1) {
			this->boardPos[4][0] = pieceTo;
			this->boardPos[7][0] = this->boardPos[5][0];
			this->boardPos[6][0] = Piece(0, { 6, 0 }, 0);
			this->boardPos[5][0] = Piece(0, { 5, 0 }, 0);
			...
			this->boardPos[4][0] = pieceTo;
			this->boardPos[0][0] = this->boardPos[3][0];
			this->boardPos[2][0] = Piece(0, { 2, 0 }, 0);
			this->boardPos[3][0] = Piece(0, { 3, 0 }, 0);
			...
			this->boardPos[4][7] = pieceTo;
			this->boardPos[7][7] = this->boardPos[5][7];
			this->boardPos[6][7] = Piece(0, { 6, 7 }, 0);
			this->boardPos[5][7] = Piece(0, { 5, 7 }, 0);
			...
			this->boardPos[4][7] = pieceTo;
			this->boardPos[0][7] = this->boardPos[3][7];
			this->boardPos[2][7] = Piece(0, { 2, 7 }, 0);
			this->boardPos[3][7] = Piece(0, { 3, 7 }, 0);
...
pair<int, vector<Move>> Board::GenerateMoves(bool isWhitePlayer) {

	pair<int, vector<Move>> moves;
...
pair<int, vector<Move>> Board::GenerateCaptures(bool isWhitePlayer) {

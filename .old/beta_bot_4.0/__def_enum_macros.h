...
// Blockers
#define get_w_block(bb) (bb[1] | bb[2] | bb[3] | bb[4] | bb[5] | bb[6])
#define get_b_block(bb) (bb[7] | bb[8] | bb[9] | bb[10] | bb[11] | bb[12])
...
// Set/Mask Utility
const u64 set_utility_K = 64ULL;
const u64 set_utility_Q = 128ULL;

const u64 set_utility_k = 256ULL;
const u64 set_utility_q = 512ULL;
